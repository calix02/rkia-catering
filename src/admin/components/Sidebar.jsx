...
function Sidebar(){
    return(
        <div className="w-60 h-screen overflow-clip rounded-2xl bg-[#F2EDE5] shadow-[2px_2px_2px_gray] border-r-2 border-[#e0e0e0] fixed left-0">
            ...
            <nav className="text-md poppins-medium w-full flex flex-col gap-3 px-3 mt-10">
                <Link className=" px-5 flex gap-2 items-center h-10 w-full rounded-lg hover:bg-[#8FA584] transition duration-300">
                    <span class="material-symbols-outlined">bar_chart</span> <p>Dashboard</p>
                </Link>
                 <Link className=" px-5 gap-2 flex items-center h-10 w-full rounded-lg hover:bg-[#8FA584] transition duration-300">
