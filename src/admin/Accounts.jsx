            ...
            {updateRole.isVisible && (
                <div className="inset-0 z-40 fixed flex justify-center items-center pointer-events-auto bg-[#00000072]">
                    <RoleCard
                        ...
                        fetchData={fetchData}
                        ref={updateRef}
                        onAnimationEnd={updateRole.handleEnd}
                        animate={updateRole.animation}
                        onClose={() => updateRole.setAnimation("fade-out")}
                    />
                </div>
            )}
                        ...
                        <table className="poppins-regular w-full text-center h-55">
                            ...
                            <tbody>
                                {currentData.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="4" className="py-10 text-gray-400 text-xl poppins-semibold">
                                            No Accounts Found
                                        </td>
                                    </tr>
                                )}
